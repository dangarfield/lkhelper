...
<template:page pageTitle="${pageTitle}">
	...
	<div class="bs-header alliance-report" id="content">
		<div class="container">
			<h1>${reportModelAllianceData.allianceData.name}</h1>
				<p>Currently ranked ${reportModelAllianceData.allianceData.rank} on the ${serverData.name} server with ${reportModelAllianceData.allianceData.points} points,
				${reportModelAllianceData.allianceData.name} have ${reportModelAllianceData.allianceData.memberCount} members who between them have ${reportModelAllianceData.allianceData.castleCount} castles.
				This alliance is currently ${reportModelAllianceData.gameStatusForAlliance}</p>
				...
				<div class="carbonad">
					<div id="azcarbon">
						<span class="carbonad-imaged">
							<a href="">
								<img id="adzerk_ad" class="carbonad-image carbonad-img" src="/assets/images/hero/alliance.png" width="130" height="100" border="0" alt="Player Report"/>
							</a>
						</span>
						...
						<ul class="nav bs-sidenav">
							<li>
								...
								<ul class="nav">
									...
									<li><a href="#alliance-report-historic-alliance-name">Historic Alliance Name</a></li>
								</ul>
							</li>
							<li>
								<a href="#members-report">Alliance Members Report</a>
								<ul class="nav">
									<li><a href="#members-report-all-members">All Members</a></li>
									<li><a href="#members-report-inactive-members">Inactive members</a></li>
									<li><a href="#members-report-new-members">New Members</a></li>
									<li><a href="#members-report-ex-members">Ex Members</a></li>
								</ul>
							</li>
							<li>
								<a href="#members-leaderboard">Alliance Members Leaderboard</a>
								<ul class="nav">
									<li><a href="#members-leaderboard-top-points">Members Top Points</a></li>
									<li><a href="#members-leaderboard-top-points-growth">Members Top Points Growth</a></li>
									<li><a href="#members-leaderboard-top-castle-count">Members Top Castle Count</a></li>
									<li><a href="#members-leaderboard-top-castle-count-growth">Members Top Castle Count Growth</a></li>
									<li><a href="#members-leaderboard-top-rank">Members Top Rank</a></li>
									<li><a href="#members-leaderboard-top-rank-growth">Members Top Rank Growth</a></li>
									<li><a href="#members-leaderboard-top-alliance-rank">Members Top Alliance Rank</a></li>
									<li><a href="#members-leaderboard-top-alliance-rank-growth">Members Top Alliance Rank Growth</a></li>
								</ul>
							</li>
							<li>
								...
								<ul class="nav">
									...
									<li><a href="#castles-report-new-castle-list-main-players">New Castle List - Through Battles</a></li>
									<li><a href="#castles-report-new-castle-list-new-players">New Castle List - Through New Joins / Visits</a></li>
									<li><a href="#castles-report-lost-castle-list-main-players">Lost Castle List - Through Battles</a></li>
									<li><a href="#castles-report-lost-castle-list-ex-players">Lost Castle List - Through Ex Players / Visits</a></li>
			...
			<layout:column cssClass="col-md-9" role="main">
				...
				<div class="bs-docs-section">
					...
					<table class="table table-striped table-hover table-responsive">
						...
						<tbody>
							<tr>
								<td>Alliance Name (normalised)</th>
					...
					<div class="highchart historicPoints"
						...
						data-subtitle="Alliance: ${reportModelAllianceData.allianceData.name}"
						data-series-count="2"
				...
				<div class="bs-docs-section">
					...
					<h3 id="members-report-inactive-members">Inactive members <i>(${reportModelAllianceData.inactiveListCount} potential inactive members)</i></h3>
				...
				<div class="bs-docs-section">
					...
					<image:allianceMapImage allianceId="${reportModelAllianceData.allianceData.id}" serverId="${serverData.id}" base="true" />
