...
<template:page pageTitle="${pageTitle}">
	...
	<div class="bs-header player-report" id="content">
		<div class="container">
			<h1>${reportModelPlayerData.playerData.name}</h1>
			<c:choose>
				<c:when test="${reportModelPlayerData.playerData.allianceId gt 0}"> <%-- Player part of an alliance --%>
					<p>Currently ranked ${reportModelPlayerData.playerData.rank} on the ${serverData.name} server with ${reportModelPlayerData.playerData.points} points,
					${reportModelPlayerData.playerData.name} is part of the ${reportModelPlayerData.allianceData.name} alliance ranked in position ${reportModelPlayerData.playerData.allianceRank} and has ${reportModelPlayerData.playerData.castleCount} castles.
					This player is currently ${reportModelPlayerData.gameStatusForPlayer}</p>
				</c:when>
				<c:otherwise> <%-- Player not part of an alliance --%>
					<p>Currently ranked ${reportModelPlayerData.playerData.rank} on the ${serverData.name} server with ${reportModelPlayerData.playerData.points} points,
					${reportModelPlayerData.playerData.name} is not part of an alliance and has ${reportModelPlayerData.playerData.castleCount} castles.
					This player is currently ${reportModelPlayerData.gameStatusForPlayer}</p>
				...
				<div class="carbonad">
					<div id="azcarbon">
						<span class="carbonad-imaged">
							<a href="">
								<img id="adzerk_ad" class="carbonad-image carbonad-img" src="/assets/images/hero/player.png" width="130" height="100" border="0" alt="Player Report"/>
							</a>
						</span>
						...
						<ul class="nav bs-sidenav">
							<li>
								...
								<ul class="nav">
									...
									<li><a href="#player-report-historic-player-name">Historic Player Name</a></li>
								</ul>
							</li>
							<li>
								<a href="#castle-report">Castle Report</a>
								<ul class="nav">
									<li><a href="#castle-report-castle-list">Castles List</a></li>
									<li><a href="#castle-report-new-castle-list">New Castles List</a></li>
									<li><a href="#castle-report-lost-castle-list">Lost Castles List</a></li>
							...
							<li>
								...
								<ul class="nav">
									...
									<li><a href="#alliance-report-historic-alliance-membership">Historic Alliance Membership</a></li>
									<li><a href="#alliance-report-alliance-castle-map">Alliance Castle Map</a></li>
									<li><a href="#alliance-report-stronghold-position">Castle Alliance Stronghold Position</a></li>
								</ul>
							</li>
						</ul>
					</div>
			...
			<layout:column cssClass="col-md-9" role="main">
				...
				<div class="bs-docs-section">
					...
					<div class="highchart historicPoints"
						...
						data-subtitle="Player: ${reportModelPlayerData.playerData.name}"
						data-series-count="2"
				...
				<div class="bs-docs-section">
					...
					<image:playerMapImage playerId="${reportModelPlayerData.playerData.id}" serverId="${serverData.id}" base="true" />
				...
				<div class="bs-docs-section">
					...
					<image:playerMapImage playerId="${reportModelPlayerData.playerData.id}" serverId="${serverData.id}" allianceId="${reportModelPlayerData.allianceData.id}" />
